...
<div class="main">
    ...
    <span><input type="hidden" id="hidden" name="txnid" placeholder="Transaction ID" value="<?php echo  "Txn" . rand(10000,99999999)?>" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Amount:</label></span>
    <span><input type="hidden" id="amount" name="amount" placeholder="Amount" value="<?php echo $game_product_data["sale_price"]; ?>" /></span>    
    </div>
    
    <div class="dv">
    <span class="text"><label>Product Info:</label></span>
    <span><input type="hidden" id="pinfo" name="pinfo" placeholder="Product Info" value="<?php echo $game_product_data["description"]; ?>" /></span>
    </div>
