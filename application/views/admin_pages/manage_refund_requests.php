        ...
        <table class="responsive-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php $bank_details = json_decode($refund_request['bank_details'],TRUE); echo $refund_request['account_number'].'<br>'.$refund_request['ifsc'].'<br>'.$refund_request['bank_name'].'<br>'.$refund_request['branch_name'].'<br>'; ?>
                    </td>
                    <td>
