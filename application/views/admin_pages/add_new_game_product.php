...
<div class="container">
    ...
    <?php
    echo form_open_multipart('add-new-game-product-exe');
      ?>
        ...
        <div class="row">
            ...
            <div class="ip-field-container col l6 m12 s12">
                ...
                <input id="product-price" class="ip-field" type="text" name="product-price">

            </div>
            <div class="ip-field-container col l6 m12 s12">

                <label for="product-sale-price">Game Product Sale Price</label>
                <input id="product-sale-price" class="ip-field" type="text" name="product-sale-price">
        ...
        <button type="submit" class="btn red" style="width: 100%; margin: 3% 0;">Add New Game Product</button>
